class InputValidators {
  ...
  static String? isYear(String? value) {
    final parsedValue = int.tryParse(value ?? "");
    if (parsedValue == null || value?.length != 4) {
      return 'El valor no es un año válido';
    } else {
      return null;
    }
  }
  ...
  static String? isPlate(String? value) {
    final emailRegex = RegExp(r'^[a-zA-Z0-9]{5,}$');
    if (!emailRegex.hasMatch(value ?? "")) {
      return 'No es una placa válida';
    } else {
      return null;
    }
  }
